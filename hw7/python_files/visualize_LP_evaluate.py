...
def plot_data(input_data, output_data, filtered_signal,ground_truth):
    ...
    #Plot Ground Truth
    axs[3].plot(ground_truth, **styles['truth'])
    axs[3].set_title("Filtered Signal - From Provided Ground Truth")
...
plot_data(input_data, output_data, LPsignal,ground_truth_data)