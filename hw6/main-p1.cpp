...
void ADC1_Init(void)
{
  ...
  */
    hadc1.Instance = ADC1;
    hadc1.Init.ClockPrescaler = ADC_CLOCK_SYNC_PCLK_DIV4;//ADC_CLOCK_ASYNC_DIV1; //ADC_CLOCK_SYNC_PCLK_DIV4 //LL_ADC_CLOCK_SYNC_PCLK_DIV2
  ...
  */
    ...
    sConfig.SamplingTime = ADC_SAMPLETIME_247CYCLES_5;//ADC_SAMPLETIME_247CYCLES_5;
